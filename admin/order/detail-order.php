                                                    ...
                                                    ?>
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if ($row['idCategory'] == 1) {
                                                                ?><img style="width: 100px;" src="../../uploads/product/smartphone/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 2) {
                                                                    ?><img style="width: 100px;" src="../../uploads/product/laptop/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 3) {
                                                                ?><img style="width: 100px;" src="../../uploads/product/tablet/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 4) {
                                                                ?><img style="width: 100px;" src="../../uploads/product/monitor/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 5) {
                                                                    ?><img style="width: 100px;" src="../../uploads/product/smarttv/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 6) {
                                                                    ?><img style="width: 100px;" src="../../uploads/product/watch/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 7) {
                                                                ?><img style="width: 100px;" src="../../uploads/product/voice/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 8) {
                                                                ?><img style="width: 100px;" src="../../uploads/product/smarthome/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 16) {
                                                                    ?><img style="width: 100px;" src="../../uploads/product/accessory/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 17) {
                                                                    ?><img style="width: 100px;" src="../../uploads/product/toys/<?= $row['versionImage'] ?>" alt=""><?php
                                                                } else if ($row['idCategory'] == 18) {
                                                                ?><img style="width: 100px;" src="../../uploads/product/driftingmachine/<?= $row['versionImage'] ?>" alt=""><?php
                                                                        } else if ($row['idCategory'] == 19) {
                                                                            ?><img style="width: 100px;" src="../../uploads/product/repair/<?= $row['versionImage'] ?>" alt=""><?php
                                                                        } else if ($row['idCategory'] == 20) {
                                                                ?><img style="width: 100px;" src="../../uploads/product/service/<?= $row['versionImage'] ?>" alt=""><?php
                                                                        }
                                                                    ?>
                                                            </td>
