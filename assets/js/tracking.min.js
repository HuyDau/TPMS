var AT = {
  ...
  init: function (a) {
    ...
    this.aff_utm_sources = a.aff_utm_sources
      ? a.aff_utm_sources
      : ["accesstrade"];
    this.aff_source_param = a.aff_source_param
      ? a.aff_source_param
      : "utm_source";
  ...
  check_scope: function () {
    var a =
      this.get_cookie("_aff_network") || this.get_param(this.aff_source_param);
  ...
  set_cookie: function (g, b, c) {
    ...
    document.cookie =
      g + "=" + b + "; " + a + ";domain=" + cookie_domain + "; path=/";
  },
