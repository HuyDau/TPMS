                ...
                <div class="form">
                    ...
                    <div class="external">
                        <form method="post" action="/Account/ExternalLogin">
                            <input name="__RequestVerificationToken" type="hidden" value="CHONmb8CoQfj5AoBYx-Cxer161buFIr44qYYJT9hFNHDvWHZd9bLtiGbewFriPWVFiTHfK_4y2HlI8XvK4-_TE_ds5c1">
                    ...
                    <div class="internal">
                        ...
                        <form method="post" action="/Account/Login">
                            <input name="__RequestVerificationToken" type="hidden" value="xycXN2YLybIalkTMXR4y-1kdzx-g3B-b-RfUIiiORZfCHQGyI0q7d-0PE8S9reeXICeQ1FAn8zFsGdn0D0Mp0fp9uNw1">
                            <input type="hidden" name="ReturnUrl" value="/">
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="button-group">
                                    ...
                                    <a class="btn btn-link ajax-content" href="/Account/Register">ĐĂNG KÝ</a>
                                </div>
                            </div>

                            <div class="row">
                                <p class="forgotpass"><a class="ajax-content" href="/Account/ForgotPassword">Quên mật khẩu?</a></p>
                            </div>
                        </form>
                    </div>
                </div>
