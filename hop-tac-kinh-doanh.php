...
<body>
    ...
    <section>
        <div class="container page-text">
            ...
            <p style="line-height: 1.2;">Khách hàng doanh nghiệp,dự án và phân phối vui lòng liên hệ: A.;<i><b>LÊ HUY DẬU</b></i>. SĐT;<font color="#085294"><b> 0386131716</b></font>
            </p>
            <p style="line-height: 1.2;">
                <font color="#085294">Email:<b>;</b><i>lehuydau2312@gmail.com</i></font>
            </p>
            <p style="line-height: 1.2;">-----------------------------------------------------------------------</p>
            <section style="color: rgb(51, 51, 51); font-family: -apple-system, BlinkMacSystemFont,Segoe UI; font-size: 13px;">
                <div class="container" style="min-width: 1200px; width: 1200px; margin-top: 0px; margin-bottom: 0px;">
                    <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList" style="margin-top: 20px; margin-right: 0px; margin-left: 0px; display: flex; color: rgb(17, 17, 17);">
                        <li itemprop="itemListElement" itemscope="" itemtype="http://schema.org/ListItem" style="margin-right: 6px; display: flex; vertical-align: middle; align-items: center; justify-content: center;">
                            <a itemprop="item" href="https://hoanghamobile.com/lien-he-khoi-van-phong" title="Liên hệ khối văn phòng" class="actived" style="color: rgb(0, 153, 129);"><span itemprop="name" content="Liên hệ khối văn phòng">Liên hệ khối văn phòng</span></a>
                        </li>
                    </ol>
                </div>
            </section>
            <section style="color: rgb(51, 51, 51); font-family: -apple-system, BlinkMacSystemFont,Segoe UI; font-size: 13px;">
                <div class="container page-text" style="min-width: 1200px; width: 1200px; margin-top: 0px; margin-bottom: 0px;">
